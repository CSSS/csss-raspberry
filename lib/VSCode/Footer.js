...
export const Footer = ({ className, style }) => {
  return (
    <footer
      className={
        'mt-8 w-full p-8 gap-4 flex flex-col bg-slate-900 border-x border-slate-800 ' +
        className
      }
      style={style}
    >
      <div className="w-full flex flex-col gap-4 lg:flex-row">
        <div className="w-full lg:grow flex flex-col">
        ...
        <div className="w-full lg:w-32 lg:flex-none flex flex-col">
          <h1>Connect</h1>
          <h2>
            <Icon.Link /> Website
          </h2>
