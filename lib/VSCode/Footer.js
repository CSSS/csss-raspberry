...
export const Footer = () => {
  return (
    <>
      <div className="mt-10 h-max py-10 px-16 flex background-400 flex-col items-center justify-between lg:flex-row footer">
      ...
      <div className="background-400 pt-10 pb-16 px-16">
        <p className="text-gray-500 text-opacity-40">
